...
一覧ページに「新規登録」ボタンを配置し、クリックで登録ページに遷移する。
...
## 画面間の導線
商品一覧ページに「新規登録」ボタンを配置し、クリックで登録ページに遷移する。
商品一覧の各行に「編集」リンクを配置し、クリックで編集ページに遷移する。
商品登録・編集完了後は商品一覧ページに遷移する。
登録・編集フォームに「キャンセル」ボタンを配置し、クリックで商品一覧に戻る。
