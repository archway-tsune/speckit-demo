...
const buttonStyles =
  'flex h-8 w-8 items-center justify-center rounded-full border border-base-900/15 text-base-900 transition-colors duration-200 hover:bg-base-100 disabled:cursor-not-allowed disabled:opacity-50';
