...
export function AdminLayout({
  ...
  const checkSession = useCallback(async () => {
    ...
    const loginWithCallback = `${loginPath}?callbackUrl=${encodeURIComponent(pathname)}`;
  ...
  }, [router, isAuthPage, sessionEndpoint, loginPath, requiredRole, pathname]);
      ...
      <div className="flex min-h-screen">
        ...
        <aside className="w-64 bg-base-900 text-base-50">
          ...
          <div className="mt-auto p-4">
            <Link
              href={`${logoutPath}?callbackUrl=${encodeURIComponent(pathname)}`}
