      ...
      <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
        ...
        <section className="mb-12">
          ...
          <div className="flex gap-4">
            ...
            <button className="rounded-full bg-accent px-6 py-2 text-sm font-medium text-base-900 transition-colors duration-200 hover:bg-accent-hover">
              アクセント
            </button>
          ...
          <div className="grid gap-6 md:grid-cols-3">
            {[1, 2, 3].map((i) => (
              ...
              >
                ...
                <Button className="mt-4 w-full">カートに追加</Button>
              </div>
            ))}
          </div>
        </section>
